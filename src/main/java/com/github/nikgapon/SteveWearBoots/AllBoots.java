...
import com.github.nikgapon.SteveWearBoots.item.BootstowearItem;
...
public abstract class AllBoots extends ArmorItem {
    ...
    public AllBoots(Type type, Properties properties) {
